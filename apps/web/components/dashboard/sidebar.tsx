...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 bg-gray-950 h-screen flex flex-col shrink-0 border-r border-gray-800">
      {/* Logo */}
      <div className="p-5 border-b border-gray-800">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-white text-base tracking-tight">Prodify</span>
        </div>
      </div>

      {/* Nav */}
      <nav className="flex-1 p-3 space-y-0.5">
        <p className="text-gray-500 text-xs font-medium uppercase tracking-wider px-3 py-2">Menu</p>
        {links.map(link => {
